...
/**
 * democracy-is-dead theme — built by `npx astryx theme build`
 * Import the CSS file alongside this module:
 *
 *   import { democracyIsDeadTheme } from './democracy-is-dead';
 *   import './democracy-is-dead.css';
 */
export const democracyIsDeadTheme = {
  ...
  tokens: {
    ...
    "--font-family-body": "var(--font-body), Arial, Helvetica, sans-serif",
    "--font-family-heading": "var(--font-heading), Arial Narrow, sans-serif",
    "--font-family-code": "var(--font-mono), 'Courier New', monospace",
    ...
    "--color-background-surface": "light-dark(#18140F, #18140F)",
    "--color-background-body": "light-dark(#100D0C, #100D0C)",
    "--color-background-card": "light-dark(#18140F, #18140F)",
    "--color-background-popover": "light-dark(#18140F, #18140F)",
    "--color-background-muted": "light-dark(#18140F, #18140F)",
    "--color-accent": "light-dark(#7A0C1E, #A11321)",
    ...
    "--color-neutral": "light-dark(#2518181A, #F1DEDD33)",
    "--color-overlay": "light-dark(#25181866, #25181899)",
    "--color-overlay-hover": "light-dark(#2518180D, #FFFFFF0D)",
    "--color-overlay-pressed": "light-dark(#2518181A, #FFFFFF1A)",
    "--color-text-primary": "light-dark(#EDE6D6, #EDE6D6)",
    "--color-text-secondary": "light-dark(#AEA28A, #AEA28A)",
    "--color-text-disabled": "light-dark(#A48B89, #705958)",
    "--color-text-accent": "light-dark(#A11321, #A11321)",
    "--color-on-dark": "light-dark(#EDE6D6, #EDE6D6)",
    "--color-on-light": "light-dark(#100D0C, #100D0C)",
    "--color-on-accent": "light-dark(#EDE6D6, #EDE6D6)",
    "--color-on-success": "light-dark(#ffffff, #171717)",
    "--color-on-error": "light-dark(#ffffff, #171717)",
    "--color-on-warning": "#171717",
    "--color-icon-accent": "light-dark(#A11321, #A11321)",
    "--color-icon-primary": "light-dark(#EDE6D6, #EDE6D6)",
    "--color-icon-secondary": "light-dark(#AEA28A, #AEA28A)",
    "--color-icon-disabled": "light-dark(#A48B89, #705958)",
    ...
    "--color-border": "light-dark(rgba(237, 230, 214, 0.18), rgba(237, 230, 214, 0.18))",
    "--color-border-emphasized": "light-dark(#EDE6D6, #EDE6D6)",
    "--color-skeleton": "light-dark(#BFA5A4, #574240)",
    ...
    "--color-background-inverted": "light-dark(#EDE6D6, #EDE6D6)",
    "--color-track": "light-dark(#BFA5A4, #574240)",
    "--radius-chat": "0px"
  },
